...
fixfile "${path}/all_victims.csv"
fixfile "${path}/defendants.csv"
fixfile "${path}/probation_sentences.csv"
fixfile "${path}/restitution_sentences.csv"
...
cat "${path}/all_victims.csv" | psql crimes -c "COPY all_victims FROM STDIN (FORMAT csv, DELIMITER '^', HEADER, NULL 'NULL', QUOTE E'\b')"

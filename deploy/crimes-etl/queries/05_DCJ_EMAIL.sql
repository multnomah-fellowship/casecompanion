SELECT     CASE_MAIN.CASE_ID_NBR, CASE_MAIN.CASE_NBR, CASE_CHARGE.CHARGE_NBR, CASE_CHARGE.CHARGE_ID_NBR,
                      ...
                      CASE_PERSON_INFO.OREGON_SID_NBR
FROM         CASE_PERSON_INFO RIGHT OUTER JOIN
                      CASE_PERSON LEFT OUTER JOIN
                      PERSON ON CASE_PERSON.DA_CODE = PERSON.PERSON_CODE ON
                      CASE_PERSON_INFO.PERSON_ID_NBR = CASE_PERSON.PERSON_ID_NBR RIGHT OUTER JOIN
                      CHARGE_SENTENCE INNER JOIN
                      CASE_CHARGE INNER JOIN
                      CASE_MAIN ON CASE_CHARGE.CASE_ID_NBR = CASE_MAIN.CASE_ID_NBR ON
                      CHARGE_SENTENCE.CHARGE_ID_NBR = CASE_CHARGE.CHARGE_ID_NBR INNER JOIN
                      ...
                      CASE_PERSON.PERSON_ID_NBR = CHARGE_SENTENCE.PERSON_ID_NBR AND
                      CASE_PERSON.CASE_ID_NBR = CASE_CHARGE.CASE_ID_NBR LEFT OUTER JOIN

SELECT     CASE_MAIN.CASE_ID_NBR, CASE_MAIN.CASE_NBR, CASE_CHARGE.CHARGE_NBR, CASE_CHARGE.CHARGE_ID_NBR,
                      ...
                      CASE_PERSON_INFO_1.LAST_NAME AS VICTIM_LAST_NAME, CASE_PERSON_ADDRESS.ADDRESS AS VICTIM_ADDRESS,
...
FROM         CASE_FLAG RIGHT OUTER JOIN
                      ...
                      CODEn_TABLE AS CODE_TABLE_1 ON CHARGE_SENTENCE.SENTENCE_TYPE = CODE_TABLE_1.TABLE_CODE LEFT OUTER JOIN

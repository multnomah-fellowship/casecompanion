...
FROM         CFA_TOM_VRN LEFT OUTER JOIN
                      ...
                      CASE_PERSON_PHONE ON CFA_TOM_VRN.PERSON_ID_NBR = CASE_PERSON_PHONE.PERSON_ID_NBR LEFT OUTER JOIN
...
WHERE     (CASE_PERSON_ADDRESS.ALL_DOCS = 'T') AND (CASE_PERSON_ADDRESS.SUB_ONLY = 'T') AND
                      (CASE_PERSON_PHONE.DEFAULT_PHONE = 'T') OR

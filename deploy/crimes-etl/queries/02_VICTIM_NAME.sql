SELECT     CFA_TOM_VRN.CASE_ID_NBR, CFA_TOM_VRN.PERSON_ID_NBR, CASE_PERSON_INFO.LAST_NAME, CASE_PERSON_INFO.FIRST_NAME,
                      ...
                      CASE_MAIN.CASE_NBR AS DA_CASE_NBR, CASE_PERSON_1.COURT_NBR AS COURT_CASE_NBR, CASE_MAIN.FIRST_ADVOCATE_CODE,
                      CASE_MAIN.SEC_ADVOCATE_CODE, CASE_PERSON_ADDRESS.EMAIL, CASE_PERSON_ADDRESS.CONFIDENTIAL_INDICATOR,
                      CASE_PERSON.UPDATE_DATE AS PERSON_UPDATE_DATE, CASE_PERSON.CREATE_DATE AS PERSON_CREATE_DATE,
                      CASE_MAIN.UPDATE_DATE AS CASE_UPDATE_DATE, PERSON.FIRST_NAME AS DDA_FIRST_NAME, PERSON.LAST_NAME AS DDA_LAST_NAME
FROM         ADDRESS RIGHT OUTER JOIN
                      PERSON_ADDRESS ON ADDRESS.ADDRESS_ID_NBR = PERSON_ADDRESS.ADDRESS_ID_NBR RIGHT OUTER JOIN
                      PERSON ON PERSON_ADDRESS.PERSON_ID_NBR = PERSON.PERSON_ID_NBR RIGHT OUTER JOIN
                      CASE_PERSON AS CASE_PERSON_1 ON PERSON.PERSON_CODE = CASE_PERSON_1.DA_CODE RIGHT OUTER JOIN
                      CFA_TOM_VRN ON CASE_PERSON_1.CASE_ID_NBR = CFA_TOM_VRN.CASE_ID_NBR AND
                      CASE_PERSON_1.CASE_PERSON_TYPE = 'DEFENDANT' AND CASE_PERSON_1.CASE_PERSON_NBR = '1' LEFT OUTER JOIN
